      ...
      <div className="max-w-6xl mx-auto px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <a
              href="#contacts"
              className="inline-block px-6 py-3 border border-accent-purple text-slate-100 bg-slate-950/70 hover:bg-accent-purple hover:text-slate-950 transition-all code-text text-sm font-semibold"
            >
              &gt; Contact me !!
            </a>
          </div>
