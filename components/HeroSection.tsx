    ...
    >
      <div className="max-w-6xl mx-auto px-4 md:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          >
            <div className="relative max-w-100 h-72 md:w-120 md:h-106 mx-auto">
              <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
                <div className="absolute -inset-34 md:-inset-20 md:left-8 top-8 left-16">
                  <Spline
            ...
            {/* Status Badge */}
            <div className="absolute bottom-0 md:bottom-1 left-1/2 md:left-62 transform -translate-x-1/2 bg-slate-950/85 border border-accent/60 px-3 md:px-6 py-2 md:py-3 md:code-text text-xs md:text-sm z-20 max-w-[calc(100%-1rem)] whitespace-nowrap md:whitespace-break-spaces">
