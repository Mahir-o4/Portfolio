        ...
        <div className="hidden md:flex items-center gap-3 shrink-0">
          {[
            ...
            <a
              ...
              title={label}
              aria-label={label}
              className="w-10 h-10 rounded-full flex items-center justify-center border border-white/10 text-[#cbd5e1] transition-all duration-150 hover:border-(--accent) hover:text-(--accent) hover:scale-105 active:scale-95"
            >
              {icon}
            </a>
          ))}
      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            {navItems.map((item, i) => (
              ...
              >
                ...
                {activeSection === item.id && (
                  <span className="text-xs px-2.5 py-1 rounded-full bg-(--accent) text-black font-mono">
                    active
                  </span>
                )}
              </motion.a>
            ...
            >
              <a href="https://github.com/Mahir-o4/" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-[#cbd5e1] hover:text-(--accent)"><Github size={22} /></a>
              <a href="https://x.com/skmahirashef04" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-[#cbd5e1] hover:text-(--accent)"><Twitter size={22} /></a>
              <a href="https://www.linkedin.com/in/mahir-ashef-011776290/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-[#cbd5e1] hover:text-(--accent)"><Linkedin size={22} /></a>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
